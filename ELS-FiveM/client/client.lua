        ...
        while true do
            if isVehicleELS and canControlELS and networkSessionActive then
                ...
                if (GetLastInputMethod(0)) then
                    ...
                    --- 4, 5, 6
                    DisableControlAction(0, keyboard.siren.tone_four, true)
                    DisableControlAction(0, keyboard.siren.tone_five, true)
                    DisableControlAction(0, keyboard.siren.tone_six, true)
                    ...
                    if IsDisabledControlPressed(0, keyboard.modifyKey) then
                        ...
                        if IsDisabledControlJustReleased(0, keyboard.stageChange) then
                            if
                                getVehicleVCFInfo(GetVehiclePedIsUsing(PlayerPedId())).interface.activationType ==
                                    "invert" or
                                    getVehicleVCFInfo(GetVehiclePedIsUsing(PlayerPedId())).interface.activationType ==
                                        "euro"
                             then
                    ...
                    if GetVehicleClass(GetVehiclePedIsUsing(PlayerPedId())) == 18 then
                        if (elsVehs[GetVehiclePedIsUsing(PlayerPedId())] ~= nil) then
                            if elsVehs[GetVehiclePedIsUsing(PlayerPedId())].stage == 3 then
                                ...
                                --- 4, 5, 6
                                if IsDisabledControlJustReleased(0, keyboard.siren.tone_four) then
                                    setSirenStateButton(4)
                                end
                                if IsDisabledControlJustReleased(0, keyboard.siren.tone_five) then
                                    setSirenStateButton(5)
                                end
                                if IsDisabledControlJustReleased(0, keyboard.siren.tone_six) then
                                    setSirenStateButton(6)
                                end
                            end
                            if elsVehs[GetVehiclePedIsUsing(PlayerPedId())].stage == 2 then
                                ...
                                if IsDisabledControlJustPressed(0, keyboard.siren.tone_four) then
                                    if playButtonPressSounds then
                                        PlaySoundFrontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1)
                                    end
                                    TriggerServerEvent("els:setSirenState_s", 4)
                                end
                                ...
                                if IsDisabledControlJustPressed(0, keyboard.siren.tone_five) then
                                    if playButtonPressSounds then
                                        PlaySoundFrontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1)
                                    end
                                    TriggerServerEvent("els:setSirenState_s", 5)
                                end
                                ...
                                if IsDisabledControlJustPressed(0, keyboard.siren.tone_six) then
                                    if playButtonPressSounds then
                                        PlaySoundFrontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1)
                                    end
                                    TriggerServerEvent("els:setSirenState_s", 6)
                                end
                            end
                        end
                    end
                    ...
                    if
                        els_Vehicles[checkCarHash(GetVehiclePedIsUsing(PlayerPedId()))] ~= nil and
                            els_Vehicles[checkCarHash(GetVehiclePedIsUsing(PlayerPedId()))].activateUp
                     then
                        if
                            IsDisabledControlPressed(0, controller.modifyKey) and
                                IsDisabledControlJustReleased(0, controller.stageChange)
                         then
                            downOneStage()
                    ...
                    if IsDisabledControlPressed(0, controller.modifyKey) then
                        ...
                        if
                            IsDisabledControlPressed(0, controller.modifyKey) and
                                IsDisabledControlJustReleased(0, controller.takedown)
                         then
                            if playButtonPressSounds then
                                PlaySoundFrontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1)
                            end
                        ...
                        if (elsVehs[GetVehiclePedIsUsing(PlayerPedId())] ~= nil) then
                            if elsVehs[GetVehiclePedIsUsing(PlayerPedId())].stage == 3 then
                                if not IsDisabledControlPressed(0, controller.modifyKey) then
                                    ...
                                    if IsDisabledControlJustReleased(0, controller.siren.tone_five) then
                                        setSirenStateButton(5)
                                    end
                                    if IsDisabledControlJustReleased(0, controller.siren.tone_six) then
                                        setSirenStateButton(6)
                                    end
                                end
                            end
...
Citizen.CreateThread(
    function()
        while true do
            if isVehicleELS and panelOffsetX ~= nil and panelOffsetY ~= nil then
                                ...
                                if vehN ~= 0 then
                                    ...
                                    if (panelType == "original") then
                                        ...
                                        _DrawRect(
                                            ...
                                            getVehicleVCFInfo(vehN).interface.headerColor.b,
                                            225,
                                            0
                                        )
                                        Draw(
                                        ...
                                        if (getVehicleLightStage(GetVehiclePedIsUsing(GetPlayerPed(-1))) == 1) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).interface.buttonColor.b,
                                                225,
                                                0
                                            )
                                            Draw(
                                        ...
                                        if elsVehs[GetVehiclePedIsUsing(GetPlayerPed(-1))] ~= nil then
                                            if elsVehs[GetVehiclePedIsUsing(GetPlayerPed(-1))].warning then
                                                ...
                                                Draw(
                                                    "E-" .. formatPatternNumber(advisorPatternSelectedIndex),
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.r,
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.g,
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.b,
                                                    255,
                                        ...
                                        if elsVehs[GetVehiclePedIsUsing(GetPlayerPed(-1))] ~= nil then
                                            if elsVehs[GetVehiclePedIsUsing(GetPlayerPed(-1))].secondary then
                                                ...
                                                Draw(
                                                    "E-" .. formatPatternNumber(lightPatternSec),
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.r,
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.g,
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.b,
                                                    255,
                                        ...
                                        if elsVehs[GetVehiclePedIsUsing(GetPlayerPed(-1))] ~= nil then
                                            if elsVehs[GetVehiclePedIsUsing(GetPlayerPed(-1))].primary then
                                                ...
                                                Draw(
                                                    "E-" .. formatPatternNumber(lightPatternPrim),
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.r,
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.g,
                                                    getVehicleVCFInfo(vehN).interface.buttonColor.b,
                                                    255,
                                        ...
                                        if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 7)) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).extras[7].env_color.b,
                                                225,
                                                0
                                            )
                                        else
                                        ...
                                        if
                                            getVehicleVCFInfo(vehN).secl.type == "traf" or
                                                getVehicleVCFInfo(vehN).secl.type == "chp"
                                         then
                                            if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 8)) then
                                                _DrawRect(
                                                    ...
                                                    getVehicleVCFInfo(vehN).extras[8].env_color.b,
                                                    225,
                                                    0
                                                )
                                            else
                                        ...
                                        if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 9)) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).extras[9].env_color.b,
                                                225,
                                                0
                                            )
                                        else
                                        ...
                                        if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 1)) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).extras[1].env_color.b,
                                                225,
                                                0
                                            )
                                        else
                                        ...
                                        if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 2)) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).extras[2].env_color.b,
                                                225,
                                                0
                                            )
                                        else
                                        ...
                                        if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 3)) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).extras[3].env_color.b,
                                                225,
                                                0
                                            )
                                        else
                                        ...
                                        if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 4)) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).extras[4].env_color.b,
                                                225,
                                                0
                                            )
                                        else
                                        ...
                                        if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 5)) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).extras[5].env_color.b,
                                                225,
                                                0
                                            )
                                        else
                                        ...
                                        if (IsVehicleExtraTurnedOn(GetVehiclePedIsUsing(GetPlayerPed(-1)), 6)) then
                                            _DrawRect(
                                                ...
                                                getVehicleVCFInfo(vehN).extras[6].env_color.b,
                                                225,
                                                0
                                            )
                                        else
                                    ...
                                    elseif panelType == "old" then
                                        ...
                                        Draw(
                                            "PRIM " .. tostring(lightPatternPrim),
                                            0,
                                            0,
                                            0,
                                            255,
                                        ...
                                        if
                                         ...
                                         then
                                            ...
                                            Draw(
                                                "ADV " .. tostring(advisorPatternSelectedIndex),
                                                0,
                                                0,
                                                0,
                                                255,
                            ...
                            for i = 11, 12 do
                                if (not IsEntityDead(k) and DoesEntityExist(k)) then
                                    if (els_Vehicles[vehN] == nil or els_Vehicles[vehN].extras == nil) then
                                        debugPrint(
                                            "Index for current vehicle (" .. vehN .. ") was nil (invalid), returning.",
                                            true,
                                            true
                                        )
                                        return
                                    ...
                                    if (IsVehicleExtraTurnedOn(k, i)) then
                                        ...
                                        if els_Vehicles[vehN].extras[i].env_light then
                                            ...
                                            if i == 12 then
                                                DrawLightWithRange(
                                                    coords.x + els_Vehicles[vehN].extras[12].env_pos.x,
                                                    coords.y + els_Vehicles[vehN].extras[12].env_pos.y,
                                                    coords.z + els_Vehicles[vehN].extras[12].env_pos.z,
                                                    255,
                                                    255,
                                                    255,
                                                    50.0,
    ...
    function()
        while true do
            if elsVehs ~= nil then
                ...
                for k, v in pairs(elsVehs) do
                    if
                        v ~= nil and DoesEntityExist(k) and
                            #(GetEntityCoords(k) - GetEntityCoords(GetPlayerPed(-1))) <= vehicleSyncDistance
                    then
                        found = true
                        ...
                        if
                            getVehicleVCFInfo(k).priml.type == "chp" and getVehicleVCFInfo(k).wrnl.type == "chp" and
                                getVehicleVCFInfo(k).secl.type == "chp"
                        then
                            if v.stage == 0 then
                                for i = 1, 10 do
                                    setExtraState(k, i, 1)
